...
import org.hbrs.se1.ws22.uebung10.*;
...
public class MyPrettyRectangleTest {
	...
	public void testGetCenter(){
		...
		//
		MyPrettyRectangle r;
		r = new MyPrettyRectangle(0.0,0.0,0.0,0.0);

		assertEquals(new MyPoint(0.0,0.0), r.getCenter());
	...
	public void testGetPerimeter(){
		...
		assertEquals(14.0, left.getPerimeter());
		assertEquals(6.0, middle.getPerimeter());
		assertEquals(14.0, somewhere.getPerimeter());
	...
	public void testGetBoundingBox( ) {
		...
		//
		// [ihr Code]
		MyPrettyRectangle[] leer = { };

		MyPrettyRectangle leerRect = new MyPrettyRectangle(0.0, 0.0, 0.0, 0.0);
		MyPrettyRectangle box = BoundingBoxFactory.createBoundingBox( leer );
		assertEquals(leerRect, box );
